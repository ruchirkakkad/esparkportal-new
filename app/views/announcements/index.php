...
<div class="hbox hbox-auto-xs hbox-auto-sm" ng-controller="MailCtrl123">
    <div class="col w-md bg-light dk b-r bg-auto">
        <div class="wrapper b-b bg">
            ...
            <a ui-sref="app.announcements.create" class="btn btn-sm btn-danger w-xs font-bold">Create New</a>
        </div>
