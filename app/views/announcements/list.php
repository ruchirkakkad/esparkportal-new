<div ng-controller="MailListCtrl123">
    <!-- header -->
    <div class="wrapper bg-light lter b-b">
        <h5>General Announcemets</h5>
    </div>
    <!-- / header -->
    ...
    <ul class="list-group list-group-lg no-radius m-b-none m-t-n-xxs">
        <li ng-repeat="mail in mails | filter:fold" ng-class="labelClass(mail.label)" class="list-group-item clearfix b-l-3x" style="{{mail.fold == 'unread' ? 'background-color : #e9e9e5' : '' }}">
            <a href="javascript:void(0);" class="avatar thumb pull-left m-r">
            ...
            <div class="clear">
                <div>
                    <a ui-sref="app.announcements.detail({mailId:mail.id})" class="text-md">{{mail.subject}}</a>
