<div class="bg-light lter b-b wrapper-md">
    <h1 class="m-n font-thin h3">Add Expense</h1>
</div>
                ...
                <form name="formValidate" class="form-horizontal form-validation" novalidate>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" ng-if="data.amount_type == 'cheque' && data.expense_type == 'credit'">
                            ...
                            <div class="form-group" ng-if="data.expense_type == 'debit' || data.expense_type == 'credit'">
