<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Add States</h1>
</div>
      ...
      <div class="col-sm-6">
        <form name="formValidate" class="form-horizontal form-validation" novalidate>
         ...
         <footer class="panel-footer text-right bg-light lter">
           <button ng-disabled="formValidate.timezones_id.$invalid || formValidate.timezones_id.$invalid || formValidate.marketing_states_name.$invalid" type="submit" class="btn btn-success" ng-click="create()">Submit</button>
         </footer>
          </div>
        </form>
      </div>
