    ...
    public function getIndexdataView()
    {
        ...
        foreach ($returndata as $key => $val) {
            foreach ($val as $key1 => $val1) {
                ...
                $returndata[$key][$key1]['edit'] = "<a href='#/app/leads_statuses/edit/$id'><button class='btn m-b-xs btn-sm btn-primary'><i class='fa fa-edit'></i></button></a>";
                $returndata[$key][$key1]['delete'] = "<a href='#/app/leads_statuses/delete/$id'><button class='btn btn-sm btn-icon btn-danger'><i class='fa fa-trash-o'></i></button></a>";
            }
        }
        return $returndata;
    }
